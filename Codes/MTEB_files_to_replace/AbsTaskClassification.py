...
class AbsTaskClassification(AbsTask):
    ...
    samples_per_label: int = 8 # default MTEB "samples_per_label" = 8
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.n_experiments: int = (  # type: ignore
            ...
            else self.metadata_dict.get("n_experiments", 10000) # default MTEB "n_experiments" = 10
        )
    ...
    def _evaluate_subset(
        ...
        **kwargs,
        ...
        for i in range(self.n_experiments):
            ...
            logger.info(f"Printing the training samples")
            print(idxs)
            print(len(X_sampled))
