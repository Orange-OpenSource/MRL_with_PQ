...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-folder", help="output folder for benchmark results", default="./benchmark-results/tomaarsen-mpnet-base-nli-matryoshka/banking77/PQ_NaiveBinarizer")
    ...
    file_path_train_embeds = f"./embeddings/tomaarsen-mpnet-base-nli-matryoshka/banking-77_tomaarsen-mpnet-base-nli-matryoshka_train-embeds_not-normalized_{matryoshka_dim}_dims.csv"
