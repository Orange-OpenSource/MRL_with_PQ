...
base_full_dim = 768
base_trunc_dim = 1 # sets the number of dimensions that embeddings will be truncated with ([1,2,4,8,16,32,64,128,256,512,768])
vec_n_subvecs = [1] # vector specifying the multiple number of subvectors to be created during the Product Quantization process
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-folder", help="output folder for benchmark results", default="./benchmark-results/tomaarsen-mpnet-base-nli/banking77/Truncated")
