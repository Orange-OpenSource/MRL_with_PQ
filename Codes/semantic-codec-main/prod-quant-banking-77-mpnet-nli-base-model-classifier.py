...
base_dim = 768
vec_n_subvecs = [1,2,4,8,16,32,64,128,256,768] # vector specifying the multiple numbers of subvectors to be created during the Product Quantization process
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-folder", help="output folder for benchmark results", default="./benchmark-results/tomaarsen-mpnet-base-nli/banking77/PQ_NaiveBinarizer")
    ...
    file_path_train_embeds = f"./embeddings/tomaarsen-mpnet-base-nli/banking-77_tomaarsen-mpnet-base-nli_train-embeds_not-normalized_{base_dim}_dims.csv"
