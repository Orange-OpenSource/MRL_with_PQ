...
class ReferenceModel(torch.nn.Module):
    ...
    def encode(self,
        ...
        for embed in embeddings:
            embed = embed[0:self.matryoshka_trunc_dim] # gets only the 'base_trunc_dim' first elements of each embed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-folder", help="output folder for benchmark results", default="./benchmark-results/tomaarsen-mpnet-base-nli-matryoshka/stanfordnlp-sst2/Truncated")
